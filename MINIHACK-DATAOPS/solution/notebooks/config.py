...
dbutils.fs.mkdirs("/FileStore/AVOps/Bronze")
bronze_path = "/FileStore/AVOps/Bronze"
dbutils.fs.mkdirs("/FileStore/AVOps/Silver")
silver_path = "/FileStore/AVOps/Silver"
dbutils.fs.mkdirs("/FileStore/AVOps/Gold")
gold_path = "/FileStore/AVOps/Gold"
